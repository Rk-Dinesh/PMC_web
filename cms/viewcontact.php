...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Future Football Academy</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Future Football Academy" name="description" />
        <meta content="Future Football Academy" name="author" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/Future Football Academy.png">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">View Contact Enquiry</h4>
   ...
   ?>
                                        ...
                                        <form action="updatecontact.php" method="POST">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" class="form-control" name="message" value="<?php echo $row['message']; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        <button type="submit" name="submit" class="btn btn-primary w-md">Update</button>
                                                    </div>
                                                </div>
                                            </div> 
                                        </form>
