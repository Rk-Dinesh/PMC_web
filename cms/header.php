                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/images/Pick_My_Course_AI.png" alt="" height="30" style="margin-top: 20px;" >
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/Pick_My_Course_AI.png" alt="" height="75">
                                </span>
                            </a>

                            <a href="index.php" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="assets/images/Pick_MY_Course_Favicon.png" alt="" height="30" style="margin-top: 20px;" >
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/Pick_My_Course_AI.png" alt="" width="150px" style="margin-top: 20px;" >
                                </span>
                            </a>
                        </div>
